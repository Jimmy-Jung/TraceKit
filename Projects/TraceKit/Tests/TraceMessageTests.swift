...
// MARK: - TraceMessage Tests

struct TraceMessageTests {
    // MARK: - Creation Tests

    @Test("TraceMessage 기본 생성")
    func createBasicTraceMessage() {
        // Given & When
    ...
    @Test("TraceMessage에 메타데이터 포함")
    func createTraceMessageWithMetadata() {
        // Given
