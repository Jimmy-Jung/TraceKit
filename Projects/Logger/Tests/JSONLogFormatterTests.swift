...
struct JSONLogFormatterTests {
    ...
    func prettyPrintOption() {
        // Given
        let formatter = JSONLogFormatter(prettyPrint: true)
        let message = LogMessage(
            level: .debug,
            message: "Debug",
            category: "Test",
    ...
    func noPrettyPrintIsSingleLine() {
        // Given
        let formatter = JSONLogFormatter(prettyPrint: false)
        let message = LogMessage(
            level: .info,
            message: "Info",
            category: "Test",
