// LogFileRetentionPolicyTests.swift
// LoggerTests
//
...
// MARK: - LogFileRetentionPolicy Tests

struct LogFileRetentionPolicyTests {
    ...
    func defaultPolicyValues() {
        // Given & When
        let policy = LogFileRetentionPolicy.default
    ...
    func debugPolicyValues() {
        // Given & When
        let policy = LogFileRetentionPolicy.debug
    ...
    func longTermPolicyValues() {
        // Given & When
        let policy = LogFileRetentionPolicy.longTerm
    ...
    func equalPolicies() {
        // Given
        let policy1 = LogFileRetentionPolicy.default
        let policy2 = LogFileRetentionPolicy.default
