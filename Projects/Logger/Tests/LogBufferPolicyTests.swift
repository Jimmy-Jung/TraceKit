...
// MARK: - LogBufferPolicy Tests

struct LogBufferPolicyTests {
    ...
    func defaultPolicyValues() {
        // Given & When
        let policy = LogBufferPolicy.default
    ...
    func realtimePolicyHasSizeOne() {
        // Given & When
        let policy = LogBufferPolicy.realtime
    ...
    func batterySaverPolicyValues() {
        // Given & When
        let policy = LogBufferPolicy.batterySaver
    ...
    func equalPolicies() {
        // Given
        let policy1 = LogBufferPolicy.default
        let policy2 = LogBufferPolicy.default
    ...
    func differentPolicies() {
        // Given
        let policy1 = LogBufferPolicy.default
        let policy2 = LogBufferPolicy.realtime
