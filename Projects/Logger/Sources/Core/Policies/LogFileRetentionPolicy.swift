...
public struct LogFileRetentionPolicy: Sendable, Equatable {
    /// 보관 일수
    ...
    /// 기본 정책 (7일 보관)
    public static let `default` = LogFileRetentionPolicy()
    
    /// 디버그용 정책 (1일 보관, 작은 크기)
    public static let debug = LogFileRetentionPolicy(
        retentionDays: 1,
    ...
    /// 장기 보관 정책 (30일)
    public static let longTerm = LogFileRetentionPolicy(
        retentionDays: 30,
