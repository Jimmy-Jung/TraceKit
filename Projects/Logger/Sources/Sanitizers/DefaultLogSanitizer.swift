...
public struct DefaultLogSanitizer: LogSanitizer {
    /// 활성화 여부
    ...
    public func sanitize(_ message: LogMessage) -> LogMessage {
...
extension DefaultLogSanitizer {
    ...
    public struct Builder {
        ...
        public init() {
            self.patterns = SensitiveDataPattern.defaults
            self.isEnabled = true
        }
        ...
        /// 빌드
        public func build() -> DefaultLogSanitizer {
            DefaultLogSanitizer(
                isEnabled: isEnabled,
                patterns: patterns
            )
