...
public actor DatadogLogDestination: LogDestination {
    ...
    public init(
        ...
        // Logger 생성
        self.datadogLogger = DatadogLogs.Logger.create(
...
extension DatadogLogDestination {
    /// 전역 속성 추가
